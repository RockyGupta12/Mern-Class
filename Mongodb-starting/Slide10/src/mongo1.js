...
const url = `mongodb+srv://grocky236:${password}cluster0.memelwn.mongodb.net/noteApp?retryWrites=true&w=majority`  //the url variable contains the connection string for MongoDB. This URL includes the username, password, host, and other details necessary to connect to a MongoDB database
...
/* output:
PS C:\Users\Rocky Gupta\OneDrive\Desktop\Mongodb-starting> npm run  server1 NbPw2Lxxxq6EC8gy@
> mongodb-starting@1.0.0 server1
> node src/mongo1.js NbPw2Lxxxq6EC8gy@
NbPw2Lxxxq6EC8gy@
saved*/
...
NbPw2Lxxxq6EC8gy@
{
  _id: new ObjectId('6596ae46036c3eb2c54c09f9'),
  content: 'rocky',
  important: true,
  __v: 0
}
{
  _id: new ObjectId('6596b51ff24552198376ec80'),
  content: 'rocky',
  important: true,
  __v: 0
}
